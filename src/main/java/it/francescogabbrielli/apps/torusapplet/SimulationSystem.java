...
public class SimulationSystem {
	...
	static final double AVOGADRO = 6.0221367e23;
	...
	private final double[] keArray = new double[10];
	private int kePointer = 0;

	private int safeAtoms;
	...
	public boolean isExploded() {
		return atomsNumber > safeAtoms * 2;
	}
